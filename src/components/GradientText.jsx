...
export default function LoopingGradientText({
  ...
  return (
    ...
    <div className={`relative flex w-full items-center justify-start ${className}`}>
      {/* Teks dengan gradien */}
      <div
        className="inline-block relative z-2 text-left text-base sm:text-lg lg:text-xl font-medium text-transparent bg-cover animate-gradient"
        style={{
          ...gradientStyle,
          backgroundClip: "text",
      ...
      >
        ...
        {/* Kursor mengetik */}
        <span
          className="ml-1 inline-block h-3 w-0.5 animate-blink bg-white"
